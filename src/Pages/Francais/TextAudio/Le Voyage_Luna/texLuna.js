...
import bookData from "./Le Voyage_luna.json";
...
const audioMap = {
  audio_part1: audioParagraph1,
  audio_part2: audioParagraph2,
  audio_part3: audioParagraph3,
  audio_part4: audioParagraph4,
  audio_part5: audioParagraph5,
  audio_part6: audioParagraph6,
...
const InteractiveBookLuna = () => {
  ...
  return (
    <Box x={{
      ...
      <Box
        sx={{
          height: { xs: "300px", sm: "400px", md: "560px" }, // Ajuste selon la taille de l'écran
          position: "relative",
          display: "block",
          ...
          boxShadow: 4,
          padding: 2,
          overflowY: "auto" // Permet de scroller sur les petits écrans si nécessaire
        }}
      >
...
export default InteractiveBookLuna;
