...
import bookData from "./tigre_chacals.json";
...
import QuizComponentTigre from "./QuizComponent";
...
const InteractiveBookTigre = () => {
  ...
  return (
    ...
    >
      ...
      <QuizComponentTigre></QuizComponentTigre>
    </Box>
  );
};

export default InteractiveBookTigre;